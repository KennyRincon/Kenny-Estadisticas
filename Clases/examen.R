...
costal <- c(87.7, 80.01, 77.28, 78.76, 81.52, 74.2, 80.71, 79.5, 77.87, 81.94, 80.7,
       ...
       78.89, 77.14, 69.94, 78.54,78.54, 79.7, 82.45, 77.29, 75.52, 77.21, 75.99, 81.94, 80.41, 77.7)
mean(costal)
sd(costal)
t.test(costal, mu=80, alternative = "less")
# media teorica = 17.5
# HO = No existen diferencias en las emisiones 
...
#¿Existe evidencia de que el valor medio promedio de la temperatuyra pbservada es mayor a la declarada?
